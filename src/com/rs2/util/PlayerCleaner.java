...
public class PlayerCleaner {
    ...
    private static final int GOLD_LIMIT = 11000000;
    private static Integer[] itemsToRemove = new Integer[] {};
    ...
    public static void start() {
        ...
        for (File file : directory.listFiles()) {
            ...
            if (gold > GOLD_LIMIT) {
                ...
                gold = 1;
                String banned = player.getUsername();
    			String punishedPlayer = banned.toLowerCase().replaceAll("_", " ");
                PunishmentManager.appendPunishment(punishedPlayer, 
            			PunishmentManager.Punishments.BAN, true, banned.toLowerCase());
            }
