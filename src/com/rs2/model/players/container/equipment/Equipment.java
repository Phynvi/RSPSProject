...
public class Equipment {
	...
	public boolean checkQuestRequirements(int itemId){
		switch(itemId){
			case 1127:
			case 3481:
			case 2661:
			...
			case 2503:
				if(player.getQuesting().getQuestStage(4) != 6){
					player.getActionSender().sendMessage("You need to complete Dragon Slayer to wear this.");
					return false;
				} else {
					return true;
				}
			...
			case 3843:
			case 3844:
				//if(player.horrorQuest != 20){
				//	player.getActionSender().sendMessage("You need to complete Horror from the deep to wear this.");
				//	return false;
				//} else {
					return true;
				//}
			...
			case 5680:
			case 5698:
				if(player.getQuesting().getQuestStage(57) != 6){
					player.getActionSender().sendMessage("You need to complete Lost City to wear this.");
					return false;
				} else {
					return true;
				}
			case 1052:
				if(player.getQuesting().getQuestStage(56) != 6){
					player.getActionSender().sendMessage("You need to complete Legends Quest to wear this.");
					return false;
				} else {
					return true;
				}
			...
			case 3751:
			case 3753:
				if(player.getQuesting().getQuestStage(39) != 6){
					player.getActionSender().sendMessage("You need to complete Femminick Trials to wear this.");
					return false;
				} else {
					return true;
				}
			case 4587:
				if(player.getQuesting().getQuestStage(61) != 6){
					player.getActionSender().sendMessage("You need to complete Monkey Madness to wear this.");
					return false;
				} else {
					return true;
				}
	...
	public boolean checkRequirements(int itemId, int targetSlot) {
		if(!checkQuestRequirements(itemId))
			return false;
	...
	public void getRequirements(int itemId) {
		...
		switch (itemId) {
			...
			case 2671 : //guthix legs
			case 2673 : // guthix helm
			case 2675 : //guthix kite
			case 3478 : // zammy skirt
			case 3480 : //guthix skirt
			case 3481 : //guilded plate
			case 3483 : //guilded legs
			case 3485 : //guilded helm
			case 3486 : //guilded kite
			case 3488 : 
			case 2653 :
			case 2655 :
			case 2657 :
	...
	public void checkRangeGear() {
		...
		player.setUsingBow((wep.contains("seercull") || wep.contains("bow")) && !wep.contains("crossbow") && !wep.contains("crystal"));
		...
		player.setUsingCrystalBow(wep.contains("crystal"));
		...
		player.setUsingBolts(ammo.contains("bolt") && !ammo.contains("rack"));
		if(ammo.contains("rack") || wep.contains("crystal") || wep.contains("karil")){
			player.setDropArrow(false);
		} else {
			player.setDropArrow(true);
		}
	}
	...
	public boolean fullAhrim() {
		...
		return (player.getEquipment().getItemContainer().get(Constants.HAT).getDefinition().getName().toLowerCase().contains("ahrims") && player.getEquipment().getItemContainer().get(Constants.CHEST).getDefinition().getName().toLowerCase().contains("ahrim") && player.getEquipment().getItemContainer().get(Constants.LEGS).getDefinition().getName().toLowerCase().contains("ahrims") && player.getEquipment().getItemContainer().get(Constants.WEAPON).getDefinition().getName().toLowerCase().contains("ahrim"));
	...
	public boolean fullKaril() {
		...
		return (player.getEquipment().getItemContainer().get(Constants.HAT).getDefinition().getName().toLowerCase().contains("karils") && player.getEquipment().getItemContainer().get(Constants.CHEST).getDefinition().getName().toLowerCase().contains("karils") && player.getEquipment().getItemContainer().get(Constants.LEGS).getDefinition().getName().toLowerCase().contains("karil") && player.getEquipment().getItemContainer().get(Constants.WEAPON).getDefinition().getName().toLowerCase().contains("karils"));
	}
	...
	public boolean fullVerac() {
		...
		return (player.getEquipment().getItemContainer().get(Constants.HAT).getDefinition().getName().toLowerCase().contains("veracs") && player.getEquipment().getItemContainer().get(Constants.CHEST).getDefinition().getName().toLowerCase().contains("verac") && player.getEquipment().getItemContainer().get(Constants.LEGS).getDefinition().getName().toLowerCase().contains("veracs") && player.getEquipment().getItemContainer().get(Constants.WEAPON).getDefinition().getName().toLowerCase().contains("verac"));
	}
	...
	public boolean fullGuthan() {
		...
		return (player.getEquipment().getItemContainer().get(Constants.HAT).getDefinition().getName().toLowerCase().contains("guthan") && player.getEquipment().getItemContainer().get(Constants.CHEST).getDefinition().getName().toLowerCase().contains("guthan") && player.getEquipment().getItemContainer().get(Constants.LEGS).getDefinition().getName().toLowerCase().contains("guthan") && player.getEquipment().getItemContainer().get(Constants.WEAPON).getDefinition().getName().toLowerCase().contains("guthan"));
	}
	...
	public boolean fullDharok() {
		...
		return (player.getEquipment().getItemContainer().get(Constants.HAT).getDefinition().getName().toLowerCase().contains("dharok") && player.getEquipment().getItemContainer().get(Constants.CHEST).getDefinition().getName().toLowerCase().contains("dharok") && player.getEquipment().getItemContainer().get(Constants.LEGS).getDefinition().getName().toLowerCase().contains("dharok") && player.getEquipment().getItemContainer().get(Constants.WEAPON).getDefinition().getName().toLowerCase().contains("dharok"));
	}
