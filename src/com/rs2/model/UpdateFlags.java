...
public class UpdateFlags {
	...
	public void sendGraphic(int graphicsId) {
		if(owner.isPlayer()){
            ...
            if(soundData != null) {
	            player.getActionSender().sendSound(soundData.getSoundId(), soundData.getSoundDelay(), 0);
	        }
        }
	...
	public void sendHighGraphic(int graphicsId) {
        if(owner.isPlayer()){
            SoundSystem.SoundData soundData = SoundSystem.SoundData.forId(graphicsId, SoundSystem.SoundType.GRAPHIC);
            if(soundData != null) {
	            ((Player)owner).getActionSender().sendSound(soundData.getSoundId(), soundData.getSoundDelay(), 0);
	        }
        }
		this.graphicsId = graphicsId;
	...
	public void sendAnimation(int animationId) {
        if(owner.isPlayer()){
        	Player player = (Player) owner;
        	//player.getActionSender().sendMessage("Animation Sound");
