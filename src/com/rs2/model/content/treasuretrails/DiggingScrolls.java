...
public class DiggingScrolls {
	...
	public static enum DigData {
		...
		DIG2(new String[]{"46 is my number. My body is burnt orange ", "colour. and crawls with those with eight.", "3 mouths I have yet I can not eat. ", "My blinking blue eye. hides my grave."}, 7274, new Position(3170, 3885), 3),
