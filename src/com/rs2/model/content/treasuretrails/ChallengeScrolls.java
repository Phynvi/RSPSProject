...
public class ChallengeScrolls {
	...
	public enum ChallengeData {
		...
		QUESTION_15(new String[]{"How many bookcases are there ", "in the palace library?"}, 2693, 7287, 24);
		//QUESTION_16(new String[]{"How many cannons does Lumbridge", "castle have?"}, 2699, 2852, 9);
