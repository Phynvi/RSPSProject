...
public class Food {
	...
	public boolean eatFood(int id, int slot) {
		...
		if (player.getSkill().canDoAction(foodTimer) && player.getSkill().getLevel()[Skill.HITPOINTS] > 0) {
			...
			if(id == 1917 || id == 1993){
				player.getActionSender().sendMessage("You drink the " + name.toLowerCase() + ".");
			} else {
