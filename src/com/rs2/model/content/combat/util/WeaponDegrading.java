...
public class WeaponDegrading {
	...
	public static void degradeEquipment(Player player) {
		for (int i = 0; i < Equipment.SIZE; i++){
			...
			//player.getActionSender().sendMessage(" Your "+ player.getEquipment().getItemContainer().get(i).getDefinition().getName() + " has degraded.");
		}
    ...
    public static int destroyBarrowItemOnDeath(Item item) {
