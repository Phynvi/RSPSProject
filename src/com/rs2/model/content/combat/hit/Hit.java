...
public class Hit {
    ...
    public void execute(List<Hit> recoilList) {
        if (hitDef.getDropItem() != null && attacker != null && attacker.isPlayer()) {
            ...
            if (player.isDropArrow() && Misc.getRandom().nextInt(10) < 4) {
        ...
        if (victim.isPlayer()) {
            ...
            WeaponDegrading.degradeEquipment(player);
        }
    ...
    private void executeAccuracy() {
        ...
        if (attacker != null && Misc.random(4) == 0) { //barrows effect
        	if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullGuthan()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2027))) {
	    		hitDef.setSpecialEffect(7);
        	} else if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullTorag()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2029))) {
        		hitDef.setSpecialEffect(8);
        	} else if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullAhrim()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2025))) {
        		hitDef.setSpecialEffect(9);
        	} else if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullKaril()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2028))) {
        		hitDef.setSpecialEffect(10);
        	} else if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullVerac()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2030))) {
        		hitDef.setSpecialEffect(11);
        	} else if (((attacker.isPlayer() && ((Player) attacker).getEquipment().fullDharok()) || (attacker.isNpc() && ((Npc) attacker).getDefinition().getId() == 2026))) {
