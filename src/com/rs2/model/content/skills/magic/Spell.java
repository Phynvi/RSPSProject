...
public enum Spell {
	...
	TELEOTHER_LUMBRIDGE(74, 1818, Graphic.highGraphic(343), 84, new Item[]{new Item(566), new Item(563), new Item(557)}), TELEOTHER_FALADOR(82, 1818, Graphic.highGraphic(343), 92, new Item[]{new Item(566), new Item(563), new Item(555)}), TELEOTHER_CAMELOT(90, 1818, Graphic.highGraphic(343), 100, new Item[]{new Item(566, 2), new Item(563)}),

	// teleport spells
	EDGEVILLE(0,714, Graphic.highGraphic(301), 0,new Item[]{}),
