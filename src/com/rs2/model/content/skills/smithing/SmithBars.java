...
public class SmithBars {
	...
	public static void smithInterface(Player player, int itemId) {
		...
		if(itemId == 2366){
			if (player.getSkill().getLevel()[Skill.SMITHING] > 59) {
				if (player.getInventory().playerHasItem(2368) && player.getInventory().playerHasItem(2366)) {
					player.getInventory().removeItem(new Item(2368));
					player.getInventory().removeItem(new Item(2366));
					player.getInventory().addItem(new Item(1187));
					player.getDialogue().sendStatement("You made a D square shield!");
		...
		if(itemId == 2368){
			if (player.getSkill().getLevel()[Skill.SMITHING] > 59) {
				if (player.getInventory().playerHasItem(2366) && player.getInventory().playerHasItem(2368)) {
					player.getInventory().removeItem(new Item(2368));
					player.getInventory().removeItem(new Item(2366));
					player.getInventory().addItem(new Item(1187));
					player.getDialogue().sendStatement("You made a D square shield!");
