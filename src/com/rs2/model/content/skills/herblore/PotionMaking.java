...
public class PotionMaking {// todo description items
	...
	public static boolean emptyPotion(Player player, Item item, int slot) {
		...
		if (description.contains("bucket") || description.contains("potion") || description.contains("dose") || description.contains("jug") || name.contains("jug") || description.contains("bowl") || description.contains("vial") || name.contains("flour") || name.contains("bucket") || description.contains("cup")) {
	...
	private static int getEmptyId(Item item) {
		...
		if (name.contains("bucket") || description.contains("bucket") || description.contains("compost")) {
			return 1925;
		}
		...
		if (name.contains("cup") || description.contains("cup")) {
			return 1980;
		}
		return -1;
	}
