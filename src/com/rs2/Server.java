...
public class Server implements Runnable {
	...
	private void startup() throws Exception {
        ...
        //SQLEngine.setForumDatabase(new SQLEngine(2, Constants.DB_DRIVER, Constants.FORUM_DB_URL, Constants.FORUM_DB_USER, Constants.FORUM_DB_PASS));
