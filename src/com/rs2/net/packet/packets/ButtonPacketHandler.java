		...
		switch (buttonId) {
			...
			case 50052:
				if(player.getQuesting().getQuestStage(25) <= 0){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Desert Treasure Quest", 8144);
					player.getActionSender().sendString("You can start this quest by talking", 8147);
					player.getActionSender().sendString("to the Archaeologist at the Bedabin Camp.", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("Minimum requirements are:", 8150);
					player.getActionSender().sendString("50 Firemaking", 8151);
					player.getActionSender().sendString("50 Magic", 8152);
					player.getActionSender().sendString("10 Slayer", 8153);
					player.getActionSender().sendString("53 Thieving", 8154);
			...
			case 28195:
				if(player.getQuesting().getQuestStage(49) <= 0){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Hero's Quest", 8144);
					player.getActionSender().sendString("You can start this quest by talking", 8147);
					player.getActionSender().sendString("to some Achietties at the heros guild.", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("Minimum requirements are:", 8150);
					player.getActionSender().sendString("25 Herblore", 8151);
					player.getActionSender().sendString("50 Mining", 8152);
					player.getActionSender().sendString("53 Fishing", 8153);
					player.getActionSender().sendString("53 Cooking", 8154);
					player.getActionSender().sendInterface(8134);
				}
				if(player.getQuesting().getQuestStage(49) == 1){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Hero's Quest", 8144);
					player.getActionSender().sendString("I need to give Achietties the following", 8147);
					player.getActionSender().sendString("Cooked Lava Eel", 8148);
					player.getActionSender().sendString("Firebird Feather", 8149);
					player.getActionSender().sendString("Master Thief Arm Band", 8150);
					player.getActionSender().sendInterface(8134);
				}
				break;
			case 28199:
				if(player.getQuesting().getQuestStage(57) <= 0){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Lost City Quest", 8144);
					player.getActionSender().sendString("You can start this quest by talking", 8147);
					player.getActionSender().sendString("to some warriors in Lumbridge", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("Minimum requirements are:", 8150);
					player.getActionSender().sendString("31 Crafting", 8151);
					player.getActionSender().sendString("36 Woodcutting", 8152);
					player.getActionSender().sendInterface(8134);
				}
				if(player.getQuesting().getQuestStage(57) == 1){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Lost City Quest", 8144);
					player.getActionSender().sendString("I need to find a special branch", 8147);
					player.getActionSender().sendString("and take it to a shed in lumbridge?", 8148);
					player.getActionSender().sendString("", 8149);
				...
				break;
			case 28215://Dragon Slayer Quest Button
				if(player.getQuesting().getQuestStage(4) <= 0){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("I can start this quest by speaking to the champions guild", 8147);
					player.getActionSender().sendString("master at the Champions Guild.", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("Minimum requirements are:", 8150);
					player.getActionSender().sendString("None.", 8151);
					player.getActionSender().sendInterface(8134);
				}
				if(player.getQuesting().getQuestStage(4) == 1){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("I need to talk to Ozaich", 8147);
				...
				if(player.getQuesting().getQuestStage(4) == 2){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("I need to Slay Elvarg", 8147);
					player.getActionSender().sendString("", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("", 8150);
					player.getActionSender().sendString("", 8151);
				...
				if(player.getQuesting().getQuestStage(4) == 3){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("I need to Slay Elvarg", 8147);
					player.getActionSender().sendString("", 8148);
				...
				if(player.getQuesting().getQuestStage(4) == 4){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("I Should return to Ozaich", 8147);
					player.getActionSender().sendString("", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("", 8150);
					player.getActionSender().sendString("", 8151);
				...
				if(player.getQuesting().getQuestStage(4) == 5){
					player.getActionSender().clearStrings();
					player.getActionSender().sendString("Dragon Slayer Quest", 8144);
					player.getActionSender().sendString("Quest Complete!", 8147);
					player.getActionSender().sendString("", 8148);
					player.getActionSender().sendString("", 8149);
					player.getActionSender().sendString("", 8150);
					player.getActionSender().sendString("", 8151);
