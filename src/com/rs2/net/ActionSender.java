...
public class ActionSender {
	...
	public ActionSender sendLogin() {
		...
		sendMessage("Welcome to " + Constants.SERVER_NAME + "@bla@.");
		sendMessage("Players Online: " + World.playerAmount());
		return this;
	}
	...
	public ActionSender clearStrings(){
	...
	public void sendWelcomeScreen() {
		...
		sendString("Welcome to Near Reality Old School Server", 15257);
		sendString("You last logged in earlier today from : localhost", 15258);
